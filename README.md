...
这几天完成小学期课设项目以及忙里偷闲刷Leetcode.

---------

今天汇报进行小学期第一周项目汇报，忙里偷闲继续准备后天的面试

---------

面试表现不佳，收拾心情继续复盘准备下一次的面试（明天）

---------

实习入职第二天啦，mentor和同事也很友好

Hello-Agent其实也完工了，一直没能更新下来，这几天忙于租房落脚…

往后就边学业务边继续冲Agent新路线！√

---------

回顾了Hello—Agent中的Extra章节，对SKILL在工业落地有了不一样的理解
